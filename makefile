...
onednn_rvv_sgemm_f32: $(UTILS_O_X86) $(UTILS_O_QEMU) $(UTILS_O_RISCV)
	$(CC_RISCV64_EMU) -O3 -o build/qemu/onednn_rvv_sgemm_f32 onednn_rvv_sgemm_f32.c $(UTILS_O_QEMU) $(RISCV_OPT)
	$(CC_RISCV64) -O3 -o build/riscv64/onednn_rvv_sgemm_f32 onednn_rvv_sgemm_f32.c $(UTILS_O_RISCV) $(RISCV_OPT)
